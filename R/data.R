#' Simulated Brain Organoids single-cell RNA-seq data
#'
...
#' \describe{
#'   \item{cluster}{integer from 1 to 13; Identity programs of the cells}
#'   \item{program.usage}{double from 0 up to 1; Usage of the state program}
#'   \item{is.doublet}{1 or 0; Wether the cell is a doublet or not}
#'   ...
#' }
